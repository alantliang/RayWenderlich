...
//  BlueLibrarySwift
//
//  Created by Alan Liang on 3/28/15.
...
@objc protocol HorizontalScrollerDelegate {
    ...
    // inform the delegate when the view at <index> has been clicked
    ...
    func reload() {
        ...
        if let delegate = self.delegate {
            ...
            views.enumerateObjectsUsingBlock {
                (object: AnyObject!, idx: Int, stop: UnsafeMutablePointer<ObjCBool>) -> Void in object.removeFromSuperview()
            }
